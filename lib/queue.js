 ...
 * of .exec(type, spec, status), normally this is a Buildy object
 * @public
 */
 ...
 * @private
 */
Queue.prototype._exec = function(type, spec, status) {
    if (this.registry.taskExists(type)) {
        this.registry.task(type).apply(this, [spec, status]);
    } else {
