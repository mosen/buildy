 ...
 *
 * @todo Seperation of design is not clear wrt buildy and utils, as buildy contains some utility functions
 * @class Buildy
    ...
    files : function(filespec, promise) {
        ...
        filespec.forEach(function(f) {
            ...
            if (/(^!|^#|[?*])/.test(f)) {
                ...
                throw new TypeError('Globbing is not yet supported. (Coming soon)');
            } else {
                fnAddFiles([f]);
            }
        });
