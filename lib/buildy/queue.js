 ...
 * - logger:   the logger that will be passed to each task for detailed log information.
 ...
 *
 * @class Queue
 * @param name {String} The name of the queue (used in logging).
 ...
 * @param params {object} valid parameters for that task type. If unspecified the task will refer to the 'defaults' option.
 * @return Queue A reference to the callee Queue object.
 * @public
 */
 ...
 *
 * @method _fork
 * @param forkspec {Object} Hash of child queue name => function
 * @protected
 */
