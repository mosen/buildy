...
var Queue = module.exports = function Queue(name, options) {
     ...
     * with the task.
     *
     * @property _taskDefaults
     * @default {}
     */
    this._taskDefaults = options.taskDefaults || {};
...
Queue.prototype._exec = function(type, params, status) {
    if (this.registry.taskExists(type)) {
        if (this._taskDefaults.hasOwnProperty(type)) {
            params = params || this._taskDefaults[type]; // TODO: merge defaults with specified parameters.
        }
