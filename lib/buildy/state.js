 ...
 * @namespace buildy
 * @class State
 * @param {Array} values The initial contents of the state object.
 * @constructor
 */
...
State.prototype = {
     ...
     * @return {Object} The item value, as an object with a single property denoting the value type.
     */
    get : function(name) {
        var item = null;
     ...
     *
     * @method keys
     * @return {Array} name of each property held in the collection
     */
    keys : function() {
        var keys = [];
     ...
     *
     * @method item
     * @param {Integer} i index of the item to retrieve.
     * @return {Object} The value of the item as an object containing a property which indicates the value type.
     */
    item : function(i) {
     ...
     *
     * @method forEach
     * @param {Function} fn Function applied for each item. Receives 2 arguments name, and the value object.
     * @param {Object} [context] Optional calling context for the inner function.
     */
    ...
    /**
     * Read the value of an item, asynchronously.
     *
     * @method read
     * @async
     * @param {Object} item The item to be read, returned from `State.get()`
     * @param {Function} cb The callback function executed with the returned value.
     * @param {Object} [context] The context that the callback should be executed in.
     */
    read : function(item, cb, context) {
        context = context || this;
        ...
        if (item.string) {
            cb.call(context, null, item.string);
        } else if (item.file) {
            fs.readFile(item.file, 'utf8', function(err, data) {
                cb.call(context, err, data);
            });
        } else {
    ...
    /**
     * Read the value of an item, synchronously.
     *
     * @method readSync
     * @param {Object} item The item to be read, returned from `State.get()`
     * @param {Function} cb The callback function executed with the returned value.
     * @param {Object} [context] The context that the callback should be executed in.
     */
    readSync : function(item, cb, context) {
        context = context || this;
    ...
    /**
     * Write the value of an item, asynchronously.
     *
     * @method write
