 ...
 *
 * Current params object format:
 * { callback: taskCallbackFunction }
 *
 * @method add
 * @param {String} name Name of the task to add, this can override builtin tasks.
 * @param {Object} params Task specifications, describes how the task will act, what kind of inputs it takes etc.
 * @public
 */
 ...
 * @return {Function} Task callback function
 */
 ...
 * @return {Boolean} True if task exists in registry.
 */
 ...
 * @private
 * @param {Object} params Task specification to validate
