...
/**
 * Grab a list of tasks that the registry knows about.
...
Registry.prototype._isTaskDefinitionValid = function(accepts) {
    var types = ['STRING', 'FILE'],
        isValid = true;

    Object.keys(accepts).forEach(function(acceptedType) {
        if (types.indexOf(acceptedType) === -1 || !accepts[acceptedType] instanceof Function) {
            isValid = false;
        }
    });
